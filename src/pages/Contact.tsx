    ...
    <div className="min-h-screen bg-sand-light">
      <section className="bg-navy text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-semibold mb-6">Let's talk</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-amber focus:border-transparent"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-amber focus:border-transparent bg-white"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 border border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-amber focus:border-transparent resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="w-full px-8 py-3 bg-amber text-white font-medium rounded-sm hover:bg-amber-dark transition-colors"
                  >
                    Send message
                  </button>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-sand rounded-lg p-6">
                <h3 className="text-lg font-semibold text-navy mb-3">Working with us</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
